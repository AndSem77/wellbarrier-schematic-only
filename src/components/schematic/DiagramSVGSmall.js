...
export default function DiagramSVGSmall({ setColor, multipleElements }) {
  const { showCdft, setFill, setStroke } = useContext(BarrierContext);
      ...
      <g id='diagram'>
        ...
        <g id='intermediate-casing'>
          ...
          <g id='intermediate-casing-valve-1'>
            <g id='Group 34'>
              <g id='intermediate-casing-valve-1_2'>
                <ellipse
                  id='Ellipse 1_9'
                  cx='10.8732'
                  cy='10.8119'
